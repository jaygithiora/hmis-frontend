...
export class SchemeCopaymentsComponent implements OnInit {
  ...
  constructor(private schemeDepartmentsService: SchemeDepartmentsService, private schemeCopaymentService: SchemeCopaymentsService,
  ...
  openModal(content: TemplateRef<any>, schemeDepartment: any) {
    ...
    if (schemeDepartment != null) {
      ...
      if (schemeDepartment.scheme_department_id != null) {
        this.scheme_departments.push({id:schemeDepartment?.id,name:`${schemeDepartment?.scheme_department?.scheme?.name} - ${schemeDepartment?.scheme_department?.department?.name}`});
