...
export class SchemeDepartmentsComponent implements OnInit {
  ...
  constructor(private departmentsService: DepartmentsService, private schemesService: SchemesService, 
    private schemeDepartmentsService:SchemeDepartmentsService, private modalService: NgbModal, 
  ...
  loadPage(page: number) {
    this.isLoading = true;
    this.schemeDepartmentsService.getSchemeDepartments(page).subscribe((result: any) => {
  ...
  addSchemeDepartment() {
    if (this.schemeDepartmentForm.valid) {
      this.isLoading = true;
      this.schemeDepartmentsService.updateSchemeDepartment(this.schemeDepartmentForm.getRawValue()).subscribe((result: any) => {
        this.isLoading = false;
        if (result.success) {
