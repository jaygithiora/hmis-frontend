...
export class ConsultationTypesComponent implements OnInit {
        ...
        this.searchDepartments$
            .pipe(
                ...
                switchMap((term) => {
                    ...
                    return this.departmentService.getDepartments(1, params);
    ...
    loadPage(page: number) {
        this.isLoading = true;
        this.consultationTypesService.getConsultationTypes(page).subscribe(
            (result: any) => {
    ...
    openModal(content: TemplateRef<any>, consultation_type: any) {
        ...
        if (consultation_type != null) {
            ...
            this.consultationTypesForm
                .get('name')
                .setValue(consultation_type.name);
            ...
            this.consultationTypesForm
                .get('consultation_fees')
                .setValue(consultation_type.consultation_fees);
            this.consultationTypesForm
                .get('status')
                .setValue(consultation_type.status);
        } else {
    ...
    addLocation() {
        if (this.consultationTypesForm.valid) {
            this.isLoading = true;
            this.consultationTypesService
                .updateConsultationType(
                    this.consultationTypesForm.getRawValue()
                )
                .subscribe(
                    (result: any) => {
                        this.isLoading = false;
