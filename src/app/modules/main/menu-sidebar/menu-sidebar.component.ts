      ...
      },*/
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        iconClasses: 'fas fa-minus icon-small',
                        path: [
                            '/dashboard/masters/insurances/schemes/departments'
                        ],
                    ...
                    },
                    {
                        ...
                        iconClasses: 'fas fa-minus icon-small',
                        path: [
                            '/dashboard/masters/insurances/schemes/copayments'
                        ],
                    ...
                    },
                    {
                        ...
                        iconClasses: 'fas fa-minus icon-small',
                        path: [
                            '/dashboard/masters/insurances/schemes/exclusions'
                        ],
                    ...
                    },
                    {
                        ...
                        iconClasses: 'fas fa-minus icon-small',
                        path: [
                            '/dashboard/masters/insurances/schemes/preauths'
                        ],
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                name: 'ID Types',
                iconClasses: 'fas fa-circle icon-small',
                path: ['/dashboard/settings/id-types'],
